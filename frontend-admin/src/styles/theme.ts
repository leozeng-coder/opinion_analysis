...
export const appTheme: ThemeConfig = {
  ...
  components: {
    ...
    Table: { borderRadius: 12, headerBg: '#f8fafc', rowHoverBg: '#f8fafc' },
    Tabs: { inkBarColor: '#4D93E8', itemSelectedColor: '#2D7AD8' },
    Button: { primaryShadow: '0 2px 0 rgba(77, 147, 232, 0.15)' },
